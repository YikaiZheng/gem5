...
for current in traffic:
    os.system(
        f"./build/NULL/gem5.opt configs/example/garnet_synth_traffic.py --network=garnet --num-cpus={cpus} --num-dirs={cpus} --topology=Spidergon --inj-vnet=0 --vcs-per-vnet=4 --depth=1 --routing-algorithm=7 --synthetic=uniform_random --sim-cycles=100000 --garnet-deadlock-threshold=100000 --injectionrate={current} --wormhole --min-num-bubbles={min_num_bubbles}"
    )
    stream = os.popen(
...
for current in traffic2:
    os.system(
        f"./build/NULL/gem5.opt configs/example/garnet_synth_traffic.py --network=garnet --num-cpus={cpus} --num-dirs={cpus} --topology=Spidergon_ALast --inj-vnet=0 --vcs-per-vnet=4 --depth=1 --routing-algorithm=8 --synthetic=uniform_random --sim-cycles=100000 --garnet-deadlock-threshold=100000 --injectionrate={current} --wormhole --min-num-bubbles={min_num_bubbles}"
    )
